...
class Label(Bin):
    ...
    def __init__(self, text = "", markup = "",
        ...
        self.display_label = _DisplayLabel(text=text, markup=markup,
        ...
        self.add_child(self.display_label)
    ...
    def __setattr__(self, name, val):
        if name in ("text", "markup", "color", "size", "max_width", "alignment"):
